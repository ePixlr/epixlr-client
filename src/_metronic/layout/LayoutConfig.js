...
export const initLayoutConfig = {
  ...
  self: {
    ...
    logo: {
      dark: toAbsoluteUrl("/media/logos/ePixlr logo.png"),
      light: toAbsoluteUrl("/media/logos/ePixlr logo.png"),
      brand: toAbsoluteUrl("/media/logos/ePixlr logo.png"),
      green: toAbsoluteUrl("/media/logos/ePixlr logo.png")
    }
  },
  // == Portlet Plugin
  // portlet: {
